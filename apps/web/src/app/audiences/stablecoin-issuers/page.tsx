...
const stablecoinCode = `import { Kontext, UsdcCompliance } from 'kontext-sdk';

const ctx = Kontext.init({
  projectId: 'stablecoin-ops',
  environment: 'production',
});

// OFAC screening before processing a USDC operation
const screen = UsdcCompliance.checkSanctionsDetailed(
  '0xRecipient...abc'
);

if (screen.isSanctioned) {
  console.log('Blocked:', screen.matchDetails);
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-4 max-w-md text-muted-foreground">
              Start with the SDK today or talk to our team about Pro
