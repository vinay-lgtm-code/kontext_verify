      ...
      <section className="bg-background">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="prose-kontext max-w-3xl">
            ...
            <ol>
              <li>
                <strong>Digest chain</strong> -- every action is SHA-256 linked
                to the one before it. Tamper with a single record and the chain
                breaks. This is your local, tamper-evident audit trail.
              </li>
              <li>
                <strong>On-chain anchor</strong> -- the terminal digest gets
                anchored to the KontextAnchor contract on Base. It&apos;s
                immutable and publicly verifiable. Anyone with an RPC URL can
                confirm the digest existed at a specific block. No Kontext
                account needed.
              </li>
              <li>
                <strong>A2A attestation</strong> -- both agents in a transaction
                exchange their terminal digests. Each side independently proves
                they ran compliance checks. The counterparty&apos;s digest is
                your receipt that they checked too.
              </li>
            </ol>
            <p>
