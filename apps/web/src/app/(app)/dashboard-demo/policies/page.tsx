...
import type { PolicyData, PolicyViolation } from '@/lib/dashboard-mock';
import { getPolicies, getPolicyViolations } from '@/lib/dashboard-mock';
                  ...
                  <div className="dash-trust-bar">
                    <div className="dash-trust-track">
                      <div
                        ...
                        style={{ width: `${Math.min(policy.impact_pct, 100)}%`, background: 'var(--dash-accent)' }}
                      />
                    </div>
